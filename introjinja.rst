...
This article was stolen from the famous  `kennethreitz/python-guide. <http://docs.python-guide.org//>`_
The introduction to jinja2 and tornado with its
...
application. The result ist mostly a html file send back to the request.
